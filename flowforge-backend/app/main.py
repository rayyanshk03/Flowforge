...
try:
    ...
    from api.route_optimizer import router as routes_router
...
# CORS Configuration
raw_origins = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:5173,http://localhost:8000").split(",")
