...
export default function EnterpriseMaritimeLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F9F8F6] text-stone-900 font-sans antialiased selection:bg-[#D94E28] selection:text-white">
      ...
      <main className="mx-auto max-w-[1440px] px-4 py-6 md:px-10 space-y-8">
        ...
        <section className="pt-2 pb-2">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <h1 className="text-3xl md:text-5xl font-extrabold text-stone-900 tracking-tight leading-[1.15]">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1 text-xs font-semibold">
                <button
                  ...
                  className="rounded-xl bg-[#D94E28] px-6 py-3 text-white shadow-sm hover:bg-[#C8401C] transition-all flex items-center gap-2 text-xs font-bold active:scale-[0.98]"
                >
                  Start Analysis <ArrowRight className="size-4" />
                </button>
                <a
                  href="#how-it-works"
                  className="rounded-xl border border-stone-300 bg-white px-6 py-3 text-stone-900 hover:bg-stone-50 transition-colors shadow-2xs text-xs font-bold"
                >
            ...
            <div className="lg:col-span-5 rounded-2xl border border-stone-200 bg-white p-5 text-xs font-sans space-y-3 shadow-sm">
              ...
              <button
                onClick={() => setCreateScenarioOpen(true)}
                className="w-full text-center rounded-xl bg-stone-100 hover:bg-stone-200 transition-colors py-2.5 text-xs font-bold text-stone-900 mt-1 border border-stone-200 flex items-center justify-center gap-2"
              >
